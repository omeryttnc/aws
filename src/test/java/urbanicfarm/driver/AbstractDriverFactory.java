...
public abstract class AbstractDriverFactory implements DriverFactory{
    ...
    protected static void setDriver(){
        LOG.trace("Web urbanicfarm.driver is set...  ***  " + Thread.currentThread().getId());
            if(System.getProperty("os.name").equals("Windows 10")){
                switch (BROWSER_TYPE){
                    ...
                    case "opera":
                        ...
                        break;
//                    case "aws":
//                        System.setProperty("webdriver.chrome.urbanicfarm.driver", "/usr/bin/chromedriver");
...
//                        break;
                    case "chrome":
                       ...
                       // System.setProperty("webdriver.chrome.urbanicfarm.driver", "C:/Users/Administrator/Documents/seleniumdependencies/chromedriver.exe");
